###########################################################################
#
# SSI PRAAT script file - v0.2 - 13.11.2015
# authors: Nivja de Jong, Ton Wempe, Andreas Seiderer and Ionut Damian
#
###########################################################################
# SR script, citation:
# -------------------------------------------------------------------------
...
#   author={de Jong, NivjaH. and Wempe, Ton},
#   pages={385-390},
#   language={English}
# }
# ------------------------------------------------------------------------- 
...
# Changelog:
# ------------------------------------------------------------------------- 
# changed 01.04.2016 by Ionut Damian
# + fixed error occuring when there are no intensity peaks
# ------------------------------------------------------------------------- 
# changed 13.11.2015 by Ionut Damian
# + added Intensity output
...
if peakcount > 0
  ...
  # output voicereport reformatted
  writeInfoLine("Duration (s): ",  originaldur)
  ...
  writeInfoLine("Pulses per sec (pulses/sec): ",  nPulses/originaldur)
...
#output intensity internally used by "Syllable Nuclei": minint, maxint, medint
#basic settings: minimum pitch: 50 Hz; time step: 0 s; subtract mean: true
#http://www.fon.hum.uva.nl/praat/manual/Sound__To_Intensity___.html
#minimum, maximum with parabolic interpolation
#http://www.fon.hum.uva.nl/praat/manual/Sound__Get_maximum___.html

writeInfoLine("Intensity minimum (dB): ", minint)
writeInfoLine("Intensity maximum (dB): ", maxint)
writeInfoLine("Intensity median (dB): ", medint)
writeInfoLine("Intensity average (dB): ", avgint)
