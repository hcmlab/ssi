...
# adapted version 19.09.2013 by Andreas Seiderer

# console version for one file (removed unnecssary file output steps)

# added voice report that uses the same wav file (without reloading)
...
# output data
writeInfoLine("Speech rate:")
writeInfoLine("   duration: ", intdur, " sec")
writeInfoLine("   voiced count: ", voicedcount)
writeInfoLine("   speech rate: ", voicedcount/intdur, " syllables/sec")
