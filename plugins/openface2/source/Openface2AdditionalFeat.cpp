...
namespace ssi {
	...
	Openface2AdditionalFeat::Openface2AdditionalFeat(const ssi_char_t* file)
		:
		_file(0) {
	...
	Openface2AdditionalFeat::~Openface2AdditionalFeat() {
		if (_file) {
	...
	void Openface2AdditionalFeat::transform_enter(ssi_stream_t& stream_in,
	...
	*/
	void Openface2AdditionalFeat::transform(ITransformer::info info,
		...
		*/
		...
		if (in[Openface2::FEATURE::DETECTION_SUCCESS] && in[Openface2::FEATURE::DETECTION_CERTAINTY] < 0.2) {
			...
			for (ssi_size_t i = 0; i < sample_number; i++)
			{
				...
				*/
				...
				if (i < sample_number - 1) {
					// Head rotations
					rotations_total[0] = rot_diff(in[i * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_X], in[(i + 1) * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_X]);
					rotations_total[1] = rot_diff(in[i * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_Y], in[(i + 1) * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_Y]);
					rotations_total[2] = rot_diff(in[i * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_Z], in[(i + 1) * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_Z]);
				}
				...
				if (_options.sd_area_mouth || _options.sum_area_mouth) {
					area = calc_area(
						calc_dist_r2(
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_59_X],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_59_Y],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_57_X],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_57_Y]
						),
						calc_dist_r2(
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_57_X],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_57_Y],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_53_X],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_53_Y]
						)
					);
					areas_total += area;
					areas[i] = area;
				...
				if (_options.sd_dist_nose_lower_lip || _options.sum_dist_nose_lower_lip) {
					dist_points = calc_dist_r2(
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_34_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_34_Y],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_67_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_67_Y]
					);
				...
				if (_options.sd_dist_nose_chin || _options.sum_dist_nose_chin) {
					dist_points = calc_dist_r2(
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_34_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_34_Y],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_9_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_9_Y]
					);
				...
				if (_options.sd_dist_chin_pose || _options.sum_dist_chin_pose) {
					dist_points = calc_dist_r2(
						in[i * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_X],
						in[i * sample_dimension + Openface2::FEATURE::POSE_CORRECTED_Y],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_9_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_9_Y]
					);
	...
	void Openface2AdditionalFeat::transform_flush(ssi_stream_t& stream_in,
		ssi_stream_t& stream_out,
		ssi_size_t xtra_stream_in_num,
		ssi_stream_t xtra_stream_in[]) {
	}
	...
	@author: Jorrit Posor
	*/
	float Openface2AdditionalFeat::calc_max_norm_mag(ssi_real_t* in, int i, int sample_dimension) {
		// Calc magnitude
		// Calc normalized magnitude
		float norm_mag =
			max
					...
					(
						...
						(
							...
							(
								calc_dist_r2
								(
									in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_31_X],
									in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_31_Y],
									in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_31_X],
									in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_31_Y]
								),
								calc_dist_r2
								(
									in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_30_X],
									in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_30_Y],
									in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_30_X],
									in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_30_Y]
								)
							),
							calc_dist_r2
							(
								in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_29_X],
								in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_29_Y],
								in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_29_X],
								in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_29_Y]
							)
						),
						calc_dist_r2
						(
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_28_X],
							in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_28_Y],
							in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_28_X],
							in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_28_Y]
						)
					),
					calc_dist_r2
					(
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_17_X],
						in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_17_Y],
						in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_17_X],
						in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_17_Y]
					)
				),
				calc_dist_r2
				(
					in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_1_X],
					in[i * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_1_Y],
					in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_1_X],
					in[(i + 1) * sample_dimension + Openface2::FEATURE::FACIAL_LANDMARK_1_Y]
				)
			);
		return norm_mag;
	}
	...
	@author: Jorrit Posor
	*/
	float Openface2AdditionalFeat::rot_diff(float rot_1, float rot_2) {
		if ((rot_1 || rot_2) <= -1.0) {
			ssi_print("case 1 \n");
			return 0.0;
		}
	...
	@author: Jorrit Posor
	*/
	float Openface2AdditionalFeat::calc_dist_r2(float point_1_1, float point_1_2, float point_2_1, float point_2_2) {
	...
	@author: Jorrit Posor
	*/
	float Openface2AdditionalFeat::calc_variance(float data[], float sum, float size) {
	...
	@author: Jorrit Posor
	*/
	float Openface2AdditionalFeat::calc_area(float height, float width) {
