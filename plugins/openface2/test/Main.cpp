...
bool ex_test(void *arg) {
	...
	sig_au_r->getOptions()->setBarNames("Inner|Brow|Raiser,Outer|Brow|Raiser,Brow|Lowerer,Upper|Lid|Raiser,Cheek|Raiser,Lid|Tightener,Nose|Wrinkler,Upper|Lip|Raiser,Lip|Corner|Puller,Dimpler,Lip|Corner|Depressor,Chin|Raiser,Lip|Stretcher,Lip|Tightener,Lips|Part,Jaw|Drop,Blink");
	...
	sig_au_c->getOptions()->setBarNames("Inner|Brow|Raiser,Outer|Brow|Raiser,Brow|Lowerer,Upper|Lid|Raiser,Cheek|Raiser,Lid|Tightener,Nose|Wrinkler,Upper|Lip|Raiser,Lip|Corner|Puller,Dimpler,Lip|Corner|Depressor,Chin|Raiser,Lip|Stretcher,Lip|Tightener,Lips|Part,Jaw|Drop,Lip|Suck,Blink");
