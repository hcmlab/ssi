...
public:
	...
	public:
		...
		Options () 
			...
			addOption ("sname", sname, SSI_MAX_CHAR, SSI_CHAR, "name of sender [deprecated, see address]");
			addOption ("ename", ename, SSI_MAX_CHAR, SSI_CHAR, "name of event [deprecated, see address]");				
		...
		void setAddress(const ssi_char_t *string) {
			if (string) {
				ssi_strcpy(this->address, string);
			}
		}
...
public: 	
	...
	static const ssi_char_t *GetCreateName () { return "FunctionalsEventSender"; };
