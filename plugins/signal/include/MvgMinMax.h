...
public:
	...
	static const ssi_char_t *GetCreateName () { return "MvgMinMax"; };
	static IObject *Create (const ssi_char_t *file) { return new MvgMinMax (file); };
	~MvgMinMax ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Computes moving/sliding minim and/or maximum of the input stream for a chosen window."; };
