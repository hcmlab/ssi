...
// 
// ****************************************************************************************
#include "RightHandRightOfShoulderRecognizer.h"

using namespace Fubi;


Fubi::RecognitionResult::Result RightHandRightOfShoulderRecognizer::recognizeOn(const FubiUser* user, Fubi::RecognitionCorrectionHint* correctionHint /*= 0x0*/)
{
