...
ssi_char_t *PythonImageFeature::ssi_log_name = "pyimfilter";

PythonImageFeature::PythonImageFeature(const ssi_char_t *file)
	: PythonFilter(file),
	_has_meta_data(false)
{
}

PythonImageFeature::~PythonImageFeature() {
}

void PythonImageFeature::setMetaData(ssi_size_t size, const void *meta) {
