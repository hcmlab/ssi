...
#ifndef SSI_RSPFEATURESTIME_H
#define SSI_RSPFEATURESTIME_H
...
class RSPFeaturesTime : public IFeature{
...
public: 	
	...
	static const ssi_char_t *GetCreateName () { return "RSPFeaturesTime"; };
	static IObject *Create (const ssi_char_t *file) { return new RSPFeaturesTime (file); };
	~RSPFeaturesTime ();

	RSPFeaturesTime::Options *getOptions () { return &_options; };
...
protected:
	...
	RSPFeaturesTime (const ssi_char_t *file = 0);
	RSPFeaturesTime::Options _options;
	ssi_char_t *_file;
