...
#ifndef SSI_BIOSIG_GSRFINDPEAKS_H
#define SSI_BIOSIG_GSRFINDPEAKS_H
...
public:
	...
	class ICallback {
	public:
		virtual void peak (ssi_time_t from, ssi_time_t to, ssi_real_t amplitude, ssi_real_t area) = 0;
	};
	...
	GSRFindPeaks (ICallback *callback, Params params);
	virtual ~GSRFindPeaks ();
...
protected:
	...
	void find_peaks (ssi_time_t sr, OverlapBuffer &gsr, OverlapBuffer &mvg);
