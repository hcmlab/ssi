...
wiimote::wiimote ()
  ...
  // not _guaranteed_ unique, see comments in header
...
int wiimote::ParseExtension (BYTE *buff, unsigned offset)
	...
	switch(Internal.ExtensionType)
        ...
        if(Internal.MotionPlus.Speed.Roll >-17.0)
        {
          int test =5;
        }
