...
ssi_char_t *ChebyshevIIFilter::ssi_log_name = "chebyshev2";

ChebyshevIIFilter::ChebyshevIIFilter (const ssi_char_t *file)
	: _file (0) {
...
ChebyshevIIFilter::~ChebyshevIIFilter () {
...
Dsp::Filter *ChebyshevIIFilter::createFilter (DspFiltersTools::FilterProperty &prop) {

	Dsp::Filter *f = 0;

	prop.family = DspFiltersTools::CHEBYSHEV_I;	
