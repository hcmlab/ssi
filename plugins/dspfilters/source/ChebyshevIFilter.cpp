...
ssi_char_t *ChebyshevIFilter::ssi_log_name = "chebyshev1";

ChebyshevIFilter::ChebyshevIFilter (const ssi_char_t *file)
	: _file (0) {
...
ChebyshevIFilter::~ChebyshevIFilter () {
...
Dsp::Filter *ChebyshevIFilter::createFilter (DspFiltersTools::FilterProperty &prop) {
