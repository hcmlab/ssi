...
#ifndef SSI_FEATURE_MICROSOFTKINECTAUFEAT_H
#define SSI_FEATURE_MICROSOFTKINECTAUFEAT_H
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "MicrosoftKinectAUFeat"; };
	...
	ssi_size_t getSampleDimensionOut(ssi_size_t sample_dimension_in) {
		if (sample_dimension_in != MicrosoftKinect::ACTIONUNIT::NUM) {
			ssi_err ("wrong sample dimension (%u != %u), is this an action unit stream?", sample_dimension_in, MicrosoftKinect::ACTIONUNIT::NUM);
		}
