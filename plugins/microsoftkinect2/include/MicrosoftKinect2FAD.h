...
#ifndef SSI_FEATURE_MICROSOFTKINECT2FAD_H
#define SSI_FEATURE_MICROSOFTKINECT2FAD_H
...
public:
	...
	ssi_size_t getSampleDimensionOut(ssi_size_t sample_dimension_in) {
		if (sample_dimension_in != MicrosoftKinect2::FACEPOINT_VALUE::NUM * MicrosoftKinect2::FACEPOINT::NUM) {
			ssi_err ("wrong sample dimension (%u != %u), is this a face stream?", sample_dimension_in, MicrosoftKinect2::FACEPOINT_VALUE::NUM * MicrosoftKinect2::FACEPOINT::NUM);
		}
		return 1;
	}
