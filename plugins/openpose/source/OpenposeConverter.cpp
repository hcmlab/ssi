	...
	*/
	void OpenposeConverter::convertOpenpose(void* fromPtr, SSI_SKELETON &to, int k) {
		...
		*/
		...
		to[SSI_SKELETON_JOINT::FACE_CHIN][SSI_SKELETON_JOINT_VALUE::POS_Y] = (from[OpenposeModelInfos::SKELETON_JOINT_BODY::NOSE][OpenposeModelInfos::SKELETON_JOINT_VALUE::POS_Y] * -1.0f) + ((from[OpenposeModelInfos::SKELETON_JOINT_BODY::NOSE][OpenposeModelInfos::SKELETON_JOINT_VALUE::POS_Y] * -1.0f  - to[SSI_SKELETON_JOINT::FACE_FOREHEAD][SSI_SKELETON_JOINT_VALUE::POS_Y]) * 2.0f);
		to[SSI_SKELETON_JOINT::FACE_CHIN][SSI_SKELETON_JOINT_VALUE::POS_CONF] = from[OpenposeModelInfos::SKELETON_JOINT_BODY::NOSE][OpenposeModelInfos::SKELETON_JOINT_VALUE::POS_CONF];
	}
}
