	...
	namespace AK {
		...
		public:
			Options() : sr(30.0),
				...
				lowpassFilterJointRotations(true)
			{
				...
				addOption("lowpassFilterJointRotations", &lowpassFilterJointRotations, 1, SSI_BOOL, "Whether to remove high frequency jittering from skeleton joint rotations");
