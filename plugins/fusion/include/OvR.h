...
#ifndef SSI_MODEL_OVR_H
#define SSI_MODEL_OVR_H
...
class OvR : public IFusion {

public:

	ssi_size_t getModelNumber(ISamples &samples);

	static const ssi_char_t *GetCreateName () { return "OvR"; };
	static IObject *Create (const ssi_char_t *file) { return new OvR (file); };
	
	IOptions *getOptions () { return 0; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Fusion: OvR"; };
