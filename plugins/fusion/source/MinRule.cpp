...
namespace ssi {
	...
	ssi_char_t *MinRule::ssi_log_name = "minrule___";

MinRule::MinRule (const ssi_char_t *file) 
	:	_file (0),
		_n_classes (0),
		_n_streams (0),
		_n_models (0),
...
bool MinRule::train (ssi_size_t n_models,
	IModel **models,
	ISamples &samples) {
...
bool MinRule::forward (ssi_size_t n_models,
	IModel **models,
...
void MinRule::print_DP(ssi_real_t **decision_profile, ssi_real_t *probs){
...
bool MinRule::save (const ssi_char_t *filepath) {
...
bool MinRule::load (const ssi_char_t *filepath) {
