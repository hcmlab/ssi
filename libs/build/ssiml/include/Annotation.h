...
namespace ssi {
	...
	public:
		...
		bool setDiscreteScheme(const ssi_char_t *scheme_name,
			...
			const ssi_size_t *class_ids = 0);
		bool setDiscreteScheme(const ssi_char_t *scheme_name,
			std::map<String, ssi_size_t> &classes, bool externalTraining = false);
		...
		bool addClass(const ssi_char_t *class_name, bool externalTraining = false);
		bool addClass(const ssi_char_t *class_name, ssi_int_t &class_id, bool externalTraining = false);
		bool addClass(ssi_int_t class_id, const ssi_char_t *class_name, bool externalTraining = false);
		bool addClass(StringList class_names, bool externalTraining = false);
