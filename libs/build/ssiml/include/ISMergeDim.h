...
#ifndef SSI_MODEL_ISMERGEDIM_H
#define SSI_MODEL_ISMERGEDIM_H

#include "base/ISamples.h"

namespace ssi {

class ISMergeDim : public ISamples {

public:

	explicit ISMergeDim (ISamples *samples);
	~ISMergeDim ();
...
class ISAlignStrms : public ISMergeDim
{
