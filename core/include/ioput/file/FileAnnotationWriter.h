...
#ifndef SSI_IOPUT_OLD_FILEANNOTATIONWRITER_H
#define SSI_IOPUT_OLD_FILEANNOTATIONWRITER_H
...
namespace ssi {
	...
	namespace old {
		...
		public:
			...
			FileAnnotationWriter(const char *filename = 0, const ssi_char_t *label = 0, const ssi_char_t *tier = 0);
